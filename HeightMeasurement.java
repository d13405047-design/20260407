...
public class HeightMeasurement {
    ...
    private static final Person[] TARGETS = {
            new Person(new Point2D.Double(320, 240), new Point2D.Double(320, 980)),
            new Person(new Point2D.Double(700, 260), new Point2D.Double(700, 960))
    };
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < targets.length; i++) {
            ...
            System.out.printf(Locale.US, "Student %d height = %.1f cm (pixel height %.1f, depth ratio %.4f)\n",
